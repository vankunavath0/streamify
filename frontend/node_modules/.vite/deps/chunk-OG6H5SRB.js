...
var messagePaginationCreatedAtAround = function messagePaginationCreatedAtAround2(_ref4) {
  ...
  if (!(messagePaginationOptions !== null && messagePaginationOptions !== void 0 && messagePaginationOptions.created_at_around))
  ...
  _createClass(Channel2, [{
    ...
    value: function _countMessageAsUnread(message) {
      ...
      if ((_message$user2 = message.user) !== null && _message$user2 !== void 0 && _message$user2.id && this.getClient().userMuteStatus(message.user.id))
        return false;
      if (Array.isArray((_this$data4 = this.data) === null || _this$data4 === void 0 ? void 0 : _this$data4.own_capabilities) && !((_this$data5 = this.data) !== null && _this$data5 !== void 0 && _this$data5.own_capabilities.includes("read-events")))
        return false;
    ...
    value: function _handleChannelEvent(event) {
      ...
      switch (event.type) {
        ...
        case "user.banned":
          ...
          break;
        case "user.unbanned":
          if (!((_event$user12 = event.user) !== null && _event$user12 !== void 0 && _event$user12.id))
            break;
          channelState.members[event.user.id] = _objectSpread$c(_objectSpread$c({}, channelState.members[event.user.id] || {}), {}, {
            shadow_banned: false,
            banned: false,
    ...
    _defineProperty(this, "subscribeRepliesRead", function() {
      return _this.client.on("message.read", function(event) {
        if (!event.user || !event.created_at || !event.thread)
          return;
        if (event.thread.parent_message_id !== _this.id)
          return;
...
var Poll = function() {
  function Poll2(_ref) {
    ...
    _defineProperty(this, "handlePollUpdated", function(event) {
      var _event$poll;
      if ((_event$poll = event.poll) !== null && _event$poll !== void 0 && _event$poll.id && event.poll.id !== _this.id)
        return;
    ...
    _defineProperty(this, "handlePollClosed", function(event) {
      var _event$poll2;
      if ((_event$poll2 = event.poll) !== null && _event$poll2 !== void 0 && _event$poll2.id && event.poll.id !== _this.id)
        return;
    ...
    _defineProperty(this, "handleVoteCasted", function(event) {
      var _event$poll3;
      if ((_event$poll3 = event.poll) !== null && _event$poll3 !== void 0 && _event$poll3.id && event.poll.id !== _this.id)
        return;
    ...
    _defineProperty(this, "handleVoteChanged", function(event) {
      var _event$poll4;
      if ((_event$poll4 = event.poll) !== null && _event$poll4 !== void 0 && _event$poll4.id && event.poll.id !== _this.id)
        return;
    ...
    _defineProperty(this, "handleVoteRemoved", function(event) {
      var _event$poll5;
      if ((_event$poll5 = event.poll) !== null && _event$poll5 !== void 0 && _event$poll5.id && event.poll.id !== _this.id)
        return;
              ...
              case 8:
                ...
                cids = Array.from(
                  items.reduce(function(acc, message) {
                    if (message.cid && !_this6.client.activeChannels[message.cid])
                      acc.add(message.cid);
                    return acc;
                  }, /* @__PURE__ */ new Set())
...
var SearchController = function() {
  function SearchController2() {
    ...
    _defineProperty(this, "removeSource", function(sourceType) {
      ...
      if (newSources.length === _this7.sources.length)
        return;
      _this7.state.partialNext({
        sources: newSources
      });
    ...
    _defineProperty(this, "deactivateSource", function(sourceType) {
      var source = _this7.getSource(sourceType);
      if (!(source !== null && source !== void 0 && source.isActive))
        return;
      if (_this7.activeSources.length === 1)
        return;
      source.deactivate();
      _this7.state.partialNext({
        sources: _toConsumableArray(_this7.sources)
...
*/
//# sourceMappingURL=chunk-OG6H5SRB.js.map
